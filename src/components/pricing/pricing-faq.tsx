...
const pricingFaqData = [
  {
    ...
    answer:
      "আমাদের বিনামূল্যে প্ল্যানটি সম্পূর্ণ বিনামূল্যে, কোনো মাসিক বা বার্ষিক চার্জ ছাড়াই। এটি শুরু করার এবং আমাদের বেসিক বৈশিষ্ট্যগুলি অন্বেষণ করার একটি দুর্দান্ত উপায়।",
  },
  {
    id: "item-2",
  ...
  return (
    <section className="container max-w-4xl py-2">
      <HeaderSection
        ...
        subtitle="সাধারণ জিজ্ঞাসার দ্রুত উত্তর খুঁজে পেতে আমাদের ব্যাপক FAQ অন্বেষণ করুন। আপনার যদি আরও সহায়তার প্রয়োজন হয়, ব্যক্তিগতকৃত সাহায্যের জন্য আমাদের সাথে যোগাযোগ করতে দ্বিধা করবেন না।"
      />
