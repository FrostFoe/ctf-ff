...
export const comparePlans: PlansRow[] = [
  {
    ...
    enterprise: "কাস্টম",
    tooltip:
      "পারফরম্যান্স ট্র্যাক করার জন্য সব প্ল্যানে বেসিক অ্যানালিটিক্স অন্তর্ভুক্ত।",
  },
  {
  ...
  },
  {
    ...
    enterprise: true,
    tooltip:
      "এন্টারপ্রাইজ প্ল্যানে একজন ডেডিকেটেড অ্যাকাউন্ট ম্যানেজার অন্তর্ভুক্ত।",
  },
  {
  ...
  },
  {
    ...
    enterprise: "কাস্টম",
    tooltip:
      "প্রো এবং উচ্চতর প্ল্যানগুলিতে মাসিক ওয়েবিনারে অ্যাক্সেস অন্তর্ভুক্ত।",
  },
  {
    ...
    business: "উপলব্ধ",
    enterprise: "উপলব্ধ",
    tooltip: "কাস্টম ইন্টিগ্রেশন বিজনেস এবং এন্টারপ্রাইজ প্ল্যানে পাওয়া যায়।",
  },
  {
