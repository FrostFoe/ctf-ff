...
- **Authentication** (Magic links, Google provider) with **Auth.js v5**
- **Database** with **Prisma** & **Neon** (PostgreSQL)
- **Emails** with **Resend** & **React Email**
- **Payments** with **Stripe** (Subscriptions, webhooks, customer portal)
- **UI Components** with **Shadcn/ui**
- **Admin Panel** with roles (admin, user)
